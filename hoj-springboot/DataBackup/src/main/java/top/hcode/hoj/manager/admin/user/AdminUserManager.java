...
public class AdminUserManager {
    ...
    public String addNewUser(List<String> user) throws StatusFailException {
        ...
        boolean result4 = userSignEntityService.save(userSign);
        boolean result5 = userPreferencesEntityService.save(userPreferences);
    ...
    public Map<Object, Object> generateUser(Map<String, Object> params) throws StatusFailException {
        ...
        boolean result4 = userSignEntityService.saveBatch(userSignList);
        boolean result5 = userPreferencesEntityService.saveBatch(userPreferencesList);
